...
var saving = require("./saveState.cjs");
...
GameBoyCore.prototype = {
  ...
  ffxxDump: require("./architecture/ffxxDump.cjs"),
  OPCODE: require("./architecture/OPCODE.cjs"),
  CBOPCODE: require("./architecture/CBOPCODE.cjs"),
  TICKTable: require("./architecture/TICKTable.cjs"),
  SecondaryTICKTable: require("./architecture/SecondaryTICKTable.cjs"),
  //-------------------------------------------------------

  //------------SAVE/LOAD----------------------------------

  saveState: saving.saveState,
  returnFromState: saving.returnFromState,
